...
const THEMES = {
	"classic_xp": {
		"name": "Classic XP",
		"table_bg": Color(0.0, 0.5, 0.0),          # the solitaire green felt
	...
	"neon_noir": {
		...
		"text_muted": Color(0.45, 0.45, 0.55),
	...
	"ember_ash": {
		...
		"text_muted": Color(0.5, 0.42, 0.35),
